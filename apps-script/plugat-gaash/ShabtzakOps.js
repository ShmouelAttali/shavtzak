 ...
 * 2. readRoster_ טוען גם את עמודת *אתמול*, כי בלעדיה אין דרך לדעת אם
 *    יום חופש הוא הראשון שלו. עמודה אופציונלית, ובלעדיה הזמינות
 *    מתנהגת בדיוק כמו לפני v3.15.
...
function readRoster_(sheet, targetDate, errors) {
  ...
  // שעת ההחלפה) צריך גם את היום שלפניו. עמודה אופציונלית: בלעדיה
  // הזמינות מתנהגת בדיוק כמו לפני v3.15.
